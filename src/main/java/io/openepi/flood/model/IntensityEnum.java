...
/**
 * Gets or Sets IntensityEnum
 */
@JsonAdapter(IntensityEnum.Adapter.class)
public enum IntensityEnum {
  ...
  public static IntensityEnum fromValue(String value) {
    for (IntensityEnum b : IntensityEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<IntensityEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final IntensityEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public IntensityEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return IntensityEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    IntensityEnum.fromValue(value);
  }
}

...
public class SunriseClient {
    ...
    private String basePath = "https://api.met.no/weatherapi/sunrise/3.0";
    ...
    private SunriseJSON sunriseJSON;
     ...
     */
    public SunriseClient(OkHttpClient client) {
        init();
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost/weatherapi/sunrise/3.0
     * @return An instance of OkHttpClient
     */
    public SunriseClient setBasePath(String basePath) {
    ...
    public SunriseClient setServers(List<ServerConfiguration> servers) {
    ...
    public SunriseClient setServerIndex(Integer serverIndex) {
    ...
    public SunriseClient setServerVariables(Map<String, String> serverVariables) {
     ...
     */
    public SunriseClient setHttpClient(OkHttpClient newHttpClient) {
     ...
     * Set JSON
     *
     * @param sunriseJSON JSON object
     * @return Api client
     */
    public SunriseClient setJSON(SunriseJSON sunriseJSON) {
        this.sunriseJSON = sunriseJSON;
        return this;
    }
     ...
     */
    public SunriseClient setVerifyingSsl(boolean verifyingSsl) {
     ...
     * @return SunriseClient
     */
    public SunriseClient setSslCaCert(InputStream sslCaCert) {
     ...
     * @return SunriseClient
     */
    public SunriseClient setKeyManagers(KeyManager[] managers) {
     ...
     * @return a {@link io.openepi.weather.SunriseClient} object
     */
    public SunriseClient setDateFormat(DateFormat dateFormat) {
        SunriseJSON.setDateFormat(dateFormat);
        return this;
    }
     ...
     * @return a {@link io.openepi.weather.SunriseClient} object
     */
    public SunriseClient setSqlDateFormat(DateFormat dateFormat) {
        SunriseJSON.setSqlDateFormat(dateFormat);
        return this;
    }
     ...
     * @return a {@link io.openepi.weather.SunriseClient} object
     */
    public SunriseClient setOffsetDateTimeFormat(DateTimeFormatter dateFormat) {
        SunriseJSON.setOffsetDateTimeFormat(dateFormat);
        return this;
    }
     ...
     * @return a {@link io.openepi.weather.SunriseClient} object
     */
    public SunriseClient setLocalDateFormat(DateTimeFormatter dateFormat) {
        SunriseJSON.setLocalDateFormat(dateFormat);
        return this;
    }
     ...
     * @return a {@link io.openepi.weather.SunriseClient} object
     */
    public SunriseClient setLenientOnJson(boolean lenientOnJson) {
        SunriseJSON.setLenientOnJson(lenientOnJson);
        return this;
    }
     ...
     * @return SunriseClient
     */
    public SunriseClient setUserAgent(String userAgent) {
     ...
     * @return SunriseClient
     */
    public SunriseClient addDefaultHeader(String key, String value) {
     ...
     * @return SunriseClient
     */
    public SunriseClient addDefaultCookie(String key, String value) {
     ...
     * @return SunriseClient
     */
    public SunriseClient setDebugging(boolean debugging) {
     ...
     * @return SunriseClient
     */
    public SunriseClient setTempFolderPath(String tempFolderPath) {
     ...
     * @return Api client
     */
    public SunriseClient setConnectTimeout(int connectionTimeout) {
     ...
     * @return Api client
     */
    public SunriseClient setReadTimeout(int readTimeout) {
     ...
     * @return Api client
     */
    public SunriseClient setWriteTimeout(int writeTimeout) {
    ...
    public String parameterToString(Object param) {
        if (param == null) {
            ...
            String jsonStr = SunriseJSON.serialize(param);
    ...
    */
    ...
    public <T> T deserialize(Response response, Type returnType) throws ApiException {
        ...
        try {
            if (isJsonMime(contentType)) {
                return SunriseJSON.deserialize(respBody.byteStream(), returnType);
    ...
    public RequestBody serialize(Object obj, String contentType) throws ApiException {
        if (obj instanceof byte[]) {
            ...
            String content;
            if (obj != null) {
                content = SunriseJSON.serialize(obj);
            } else {
                content = null;
            }

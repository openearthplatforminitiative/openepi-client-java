...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.crop_health.model.BinaryPredictionResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.crop_health.model.MultiHLTPredictionResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.crop_health.model.Ping200Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.crop_health.model.Ping500Response.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.crop_health.model.SingleHLTPredictionResponse.CustomTypeAdapterFactory());

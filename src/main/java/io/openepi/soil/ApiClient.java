...
public class ApiClient {
    ...
    private String basePath = "https://api-test.openepi.io/soil";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api-test.openepi.io/soil",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.2.5/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-test.openepi.io/soil
     ...
     * @return a {@link io.openepi.soil.ApiClient} object
     */

...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.deforestation.model.BasinProperties.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.deforestation.model.DeforestationBasinFeature.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.deforestation.model.DeforestationBasinGeoJSON.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.deforestation.model.Geometry.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.deforestation.model.HTTPValidationError.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.deforestation.model.LossYear.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.deforestation.model.MultiPolygon.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.deforestation.model.Polygon.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.deforestation.model.ValidationError.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.openepi.deforestation.model.ValidationErrorLocInner.CustomTypeAdapterFactory());
